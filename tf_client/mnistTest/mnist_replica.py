...
from tf_client.scripts import  helper

flags = tf.app.flags

module_path = os.path.dirname(__file__)
data_path = module_path + '/MNIST_data'

flags.DEFINE_string("data_dir", data_path,
                    "Directory for storing mnist data")
# flags.DEFINE_string("data_dir", "tf_client/mnistTest/mnist-data",
#                     "Directory for storing mnist data")
...
if __name__ == "__main__":
    ...
    k_FLAGS, unparsed = parser.parse_known_args()
    cluster_spec = helper.tf_cluster.parse_cluster_spec(k_FLAGS.cluster_spec)
    FLAGS.ps_hosts = ",".join(cluster_spec["ps"])
    FLAGS.worker_hosts = ",".join(cluster_spec["worker"])
    FLAGS.task_index = k_FLAGS.task_id
    FLAGS.job_name = k_FLAGS.job_name
